...
${OBJECTDIR}/src/Comparator.o: src/Comparator.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/Comparator.o.d 
	@${RM} ${OBJECTDIR}/src/Comparator.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/Comparator.c  -o ${OBJECTDIR}/src/Comparator.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/Comparator.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/src/Comparator.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/src/Comparator.o: src/Comparator.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/Comparator.o.d 
	@${RM} ${OBJECTDIR}/src/Comparator.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/Comparator.c  -o ${OBJECTDIR}/src/Comparator.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/Comparator.o.d"        -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/src/Comparator.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
